...
public class Software extends JFrame {
	...
	public Software(String usuario, String Articulo) throws SQLException {
		...
		//Al igula que en hardware y en maintenance creamos varios botones que nos lleven a distintas ventanas en este caso
		//a principal tambien tenemos botones que nos llevan a añadir, modificar y eliminar
		...
		//creamos la tabla donde muestre los articulos de la ventana en la que estamos en este caso software
